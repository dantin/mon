...
#define MS_DAY  60 * MS_HOUR
#define MS_WEEK 7 * MS_DAY
#define MS_YEAR 52 * MS_WEEK

/*
 * Convert the given `str` representation to microseconds, e.g.
 *  "10ms", "5s", "2m", "1h", etc.
 */
...
/*
 * Convert the given `str` representation to milliseconds, e.g.
 *  "10ms", "5s", "2m", "1h", etc.
 */
 ...
 * value must be `free()` by developer.
 */
...
/*
 * Convert the given `ms` to a long string.
 * This value must be `free()` by developer.
 */
